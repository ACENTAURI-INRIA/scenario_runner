...
class Context0_1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
                 debug_mode=False, criteria_enable=True, adversary_type=False, timeout=1200):
        """
        ...
        super(Context0_1, self).__init__("Context0_1", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable)
    ...
    def _calculate_base_transform(self, _start_distance, waypoint):
        ...
        offset = {"orientation": 270, "position": 50, "z": 0.6, "k": 2.5}
