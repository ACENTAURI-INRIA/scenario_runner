...
class Context0_3(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
                 debug_mode=False, criteria_enable=True, adversary_type=False, timeout=600):
        """
        ...
        super(Context0_3, self).__init__("Context0_3", ego_vehicles, config,world, debug_mode, criteria_enable=criteria_enable)
    ...
    def _calculate_base_transform(self, _start_distance, waypoint):
        ...
        offset = {"orientation": 220, "position": 50, "z": 0.6, "k": 1.0}
    ...
    def _create_behavior(self):
        ...
        actor_drive = DriveDistance(self.other_actors[0], 2 * lane_width, name="walker drive distance")
